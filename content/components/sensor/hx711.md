...
{{< img src="hx711-full.jpg" alt="Image" caption="HX711 Load Cell Amplifier. Image by `SparkFun`_ licensed and re-distributed under [CC BY 2.0](https://creativecommons.org/licenses/by/2.0/)." width="60.0%" class="align-center" >}}
